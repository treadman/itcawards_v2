...
<cfif pgfn IS 'verify'>
	<cflock name="program_userLock" timeout="60">
		...
		<cfif CheckProgramUser.RecordCount IS 0 AND CheckForRegister.recordcount IS 0>
			...
			<cfif status EQ 0>
				<cfset emailTemplateID = 61>
				<cfif thisIDH EQ "" OR mid(thisIDH,2,3) EQ "N/A">
					<cfset thisIDH = "777777">
				</cfif>
...
<cfif pgfn IS 'input'>							
	...
	<form action="#CurrentPage#" method="post" NAME="form_entry" onSubmit="return validateForm();">
		...
		<table border="0" align="center">
			...
			<tr><td align="right" class="welcome">Agency Name </td><td><input type="text" name="branch_name" size="30" maxlength="64" value="#branch_name#"></td></tr>
			...
			<tr><td align="right" class="welcome">&nbsp;</td><td>&nbsp;</td></tr>
			<tr><td align="right" class="welcome">Agency Address </td><td><input type="text" name="branch_address1" size="30" maxlength="64" value="#branch_address1#"></td></tr>
			<tr><td align="right" class="welcome">Agency City </td><td><input type="text" name="branch_city1" size="15" maxlength="30" value="#branch_city1#"></td></tr>
			<tr><td align="right" class="welcome">Agency State </td><td><input type="text" name="branch_state1" size="2" maxlength="2" value="#branch_state1#"></td></tr>
			<tr><td align="right" class="welcome">Agency Zip </td><td><input type="text" name="branch_zip1" size="10" maxlength="32" value="#branch_zip1#"></td></tr>
			<tr><td align="right" class="welcome">&nbsp;</td><td>&nbsp;</td></tr>
