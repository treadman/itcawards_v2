...
<!--- Static variables --->
<cfset created_user_ID = 1000000072>
<cfset program_ID = 1000000072>
<cfset Points = 10>
<cfset HoldPoints = 0>
...
<font face="Arial, Helvetica, sans-serif">
	<table cellpadding="0" cellspacing="0" border="0" width="800">
		<tr>
			...
			<td width="425" height="168" valign="bottom"><img src="pics/program/tt_image.jpg" width="425" height="148" alt="Henkel Rewards Board" border="0"></td>
	...
	<cflock name="program_userLock" timeout="60">
		...
		<cfif CheckProgramUser.RecordCount IS 0 AND CheckForRegister.recordcount IS 0>
			...
			<cfquery name="GetRegion" datasource="#application.DS#">
				...
				AND states LIKE <cfqueryparam value="%#branch_state1#%" cfsqltype="CF_SQL_VARCHAR">
			</cfquery>
			<cfset thisRegion = 0>
			<cfif GetRegion.recordcount EQ 1>
				<cfset thisRegion = right(trim(GetRegion.sap_ty),8)>
			</cfif>
