...
<td align="right">
	...
	<cfelse>
		<a href="<cfoutput>#CurrentPage#?c=#c#&p=#p#&g=#g#&OnPage=1</cfoutput>" class="main_paging_active">&laquo;</a>
	</cfif>
</td>
<!--- previous page --->
<td align="right">
	<cfif OnPage EQ 1>
		<span class="main_paging_selected">&nbsp;</span>
	<cfelse>
		<a href="<cfoutput>#CurrentPage#?c=#c#&p=#p#&g=#g#&OnPage=#Max(DecrementValue(OnPage),1)#</cfoutput>" class="main_paging_active">prev</a>
	</cfif>
</td>
<cfif TotalPages_ProductDisplay GT MaxPages AND OnPage GT MaxPages>
	<td><a href="<cfoutput>#CurrentPage#?c=#c#&p=#p#&g=#g#&OnPage=#StartPage-MaxPages#</cfoutput>" class="main_paging_active">...</a></td>
</cfif>
<!--- page number links --->
<cfif TotalPages_ProductDisplay GT 1>
	<cfloop index="PagingLoop" from="#StartPage#" to="#EndPage#">
		...
		<cfelse>
			<td><cfoutput><a href="#CurrentPage#?c=#c#&p=#p#&g=#g#&OnPage=#PagingLoop#" class="main_paging_active">#PagingLoop#</a></cfoutput></td>
		</cfif>
	</cfloop>
<cfelse>
	<td></td>
...
<cfif TotalPages_ProductDisplay GT MaxPages AND OnPage LT TotalPages_ProductDisplay - ( TotalPages_ProductDisplay MOD MaxPages ) + 1>
	<td><a href="<cfoutput>#CurrentPage#?c=#c#&p=#p#&g=#g#&OnPage=#EndPage+1#</cfoutput>" class="main_paging_active">...</a></td>
</cfif>
<!--- next page --->
<td align="left">
	<cfif OnPage LT TotalPages_ProductDisplay>
		<a href="<cfoutput>#CurrentPage#?c=#c#&p=#p#&g=#g#&OnPage=#Min(IncrementValue(OnPage),TotalPages_ProductDisplay)#</cfoutput>" class="main_paging_active">next</a>
	<cfelse>
		<span class="main_paging_selected">&nbsp;</span>
	</cfif>
</td>
...
<td align="left">
	<cfif OnPage LT TotalPages_ProductDisplay>
		<a href="<cfoutput>#CurrentPage#?c=#c#&p=#p#&g=#g#&OnPage=#TotalPages_ProductDisplay#</cfoutput>" class="main_paging_active">&raquo;</a>
	<cfelse>
		<span class="main_paging_selected">&nbsp;</span>
	</cfif>
</td>
