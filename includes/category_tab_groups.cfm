			...
			<tr height="40px;">
				...
				<cfoutput query="SelectProgramsAllGroups">
					...
					<cfif g EQ group_ID>
						...
						>#group_name#</td>
					<cfelse>
						<td align="center" class="active_group" width="#this_width#px;" onMouseOver="mOver(this,'selected_group');" onMouseOut="mOut(this,'active_group');" onClick="window.location='main.cfm?c=#c#&p=#p#&g=#group_ID#'">#group_name#</td>
					</cfif>
				</cfoutput>
