<!---	This adds people to the 'henkel_register' table with a status.
		...
		Status Codes:
			...
			0 - Everything is fine.  Distributor was found.  Points Awarded.  Yada yada yada.
			1 - Could not find distributor by company name in 'henkel_distributor', but found in region.
...
<cfparam name="agency_name" default="">
...
<!--- Static variables --->
<cfset created_user_ID = 1000000071>
<cfset program_ID = 1000000071>
<cfset Points = 10>
<cfset HoldPoints = 0>
...
<cfif pgfn IS 'verify'>
	...
	<cfif branch_name IS ""><cfset ErrorMessage = ErrorMessage & 'Please enter your company name<br />'></cfif>
	<cfif branch_address1 IS ""><cfset ErrorMessage = ErrorMessage & 'Please enter your address<br />'></cfif>
	<cfif branch_city1 IS ""><cfset ErrorMessage = ErrorMessage & 'Please enter your city<br />'></cfif>
	<cfif branch_state1 IS ""><cfset ErrorMessage = ErrorMessage & 'Please enter your state<br />'></cfif>
	<cfif branch_zip1 IS ""><cfset ErrorMessage = ErrorMessage & 'Please enter your zip code<br />'></cfif>
	<cfif agency_name IS ""><cfset ErrorMessage = ErrorMessage & 'Please enter your agency name<br />'></cfif>
...
<cfif pgfn IS 'verify'>
	<cflock name="program_userLock" timeout="60">
		...
		<cfif CheckProgramUser.RecordCount IS 0 AND CheckForRegister.recordcount IS 0>
			...
			<cfif NOT hasDistributor>
				<!--- Could not find distributor by company name. --->
				<cfset status = 2>
			</cfif>
			...
			<cfif status EQ 0>
				<cfset emailTemplateID = 60>
				<cfif thisIDH EQ "" OR mid(thisIDH,2,3) EQ "N/A">
					<cfset thisIDH = "666666">
				</cfif>
			...
			<cfquery name="AddRegistration" datasource="#application.DS#">
				INSERT INTO #application.database#.henkel_register (
					created_user_ID, created_datetime, email, username, fname, lname, user_function, phone, company, agency_name,
					is_international, address1, city, state, zip, region, program_ID, program_user_ID, status, registration_type)
				VALUES (
					<cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#created_user_ID#" maxlength="10">,
					'#FLGen_DateTimeToMySQL()#',
					<cfqueryparam cfsqltype="CF_SQL_VARCHAR" value="#form.email#" maxlength="128">,
					...
					<cfqueryparam cfsqltype="CF_SQL_VARCHAR" value="#form.phone#" maxlength="35">,
					<cfqueryparam cfsqltype="CF_SQL_VARCHAR" value="#thisDistributor#" maxlength="64">,
					<cfqueryparam cfsqltype="CF_SQL_VARCHAR" value="#form.agency_name#" maxlength="64">,
...
<cfif pgfn IS 'input'>							
	...
	<form action="#CurrentPage#" method="post" NAME="form_entry" onSubmit="return validateForm();">
		...
		<table border="0" align="center">
			...
			<tr><td align="right" class="welcome">Company Name </td><td><input type="text" name="branch_name" size="30" maxlength="64" value="#branch_name#"></td></tr>
			...
			<tr><td align="right" class="welcome">Company Address </td><td><input type="text" name="branch_address1" size="30" maxlength="64" value="#branch_address1#"></td></tr>
			<tr><td align="right" class="welcome">Company City </td><td><input type="text" name="branch_city1" size="15" maxlength="30" value="#branch_city1#"></td></tr>
			<tr><td align="right" class="welcome">Company State </td><td><input type="text" name="branch_state1" size="2" maxlength="2" value="#branch_state1#"></td></tr>
			<tr><td align="right" class="welcome">Company Zip </td><td><input type="text" name="branch_zip1" size="10" maxlength="32" value="#branch_zip1#"></td></tr>
			<tr><td align="right" class="welcome">Agency Name </td><td><input type="text" name="agency_name" size="30" maxlength="64" value="#agency_name#"></td></tr>
			<tr><td align="right" class="welcome">&nbsp;</td><td>&nbsp;</td></tr>
