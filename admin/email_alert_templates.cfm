...
<cfelseif delete NEQ '' AND FLGen_HasAdminAccess(1000000072)>
	<cfquery name="DeleteItem" datasource="#application.DS#">
		DELETE FROM #application.database#.email_templates
...
<cfif pgfn EQ "list">
	...
	<cfquery name="SelectList" datasource="#application.DS#">
		...
		FROM #application.database#.email_templates t
		LEFT JOIN #application.database#.xref_program_email x ON x.email_alert_ID = t.id
		LEFT JOIN #application.database#.program pr ON pr.ID = x.program_ID
		<cfif LEN(xT) GT 0>
			WHERE t.email_text LIKE <cfqueryparam cfsqltype="cf_sql_varchar" value="%#PreserveSingleQuotes(xT)#%">
	...
	<span class="pagetitle">Email Alert Template List</span>
	<br /><br />
...
<cfelseif pgfn EQ "add" OR pgfn EQ "edit" OR pgfn EQ "copy">
	...
	<cfif pgfn EQ "edit" OR pgfn EQ "copy">
		...
		<cfquery name="FindThisItemsXrefs" datasource="#application.DS#">
			...
			FROM #application.database#.xref_program_email
			WHERE email_alert_ID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#ID#" maxlength="10">
		</cfquery>
...
<cfinclude template="/cfscripts/dfm_common/tinymce.cfm">
	...
	<td valign="top"><input type="text" name="email_title" value="#email_title#" maxlength="40" size="40"><input type="hidden" name="email_title_required" value="You must enter a title for the email."></td>
	</tr>
	...
	<tr class="content">
	<td valign="top" colspan="2" align="center"><textarea name="email_text" cols="80" rows="30">#email_text#</textarea><input type="hidden" name="email_text_required" value="You must enter text for the email."></td>
	</tr>
	...
	<td valign="top">
		<cfloop query="SelectAllXrefItems">
			...
			<span class="<cfif IIF(FLForm_Selected(this_items_xrefs,this_xitem_ID,"yes") EQ "yes",DE(true),DE(false))>selecteditem<cfelse>reg</cfif>">#checkbox_text#</span><br>
		</cfloop>
	</td>
	</tr>
	<!--- END XREF --->
