...
<cfloop list="#OrdersToPrint#" index="i_order">
	...
	<cfquery name="FindOrderInfo" datasource="#application.DS#">
		SELECT program_ID AS this_program_ID, order_number, snap_fname, snap_lname, snap_ship_company, snap_ship_fname, snap_ship_lname, snap_ship_address1, snap_ship_address2, snap_ship_city, snap_ship_state, snap_ship_zip, snap_phone, snap_email, order_note
	...
	<td colspan="4">
		...
		<td valign="top" class="printlabel">
			<b>QTY: <cfif thisindv_qty GT 1><span class="highlight">#thisindv_qty#</span><cfelse>#thisindv_qty#</cfif></b>&nbsp;&nbsp;&nbsp;<span class="highlight"><span class="printpo">#FLITC_GetProgramName(FindOrderInfo.this_program_ID)#</span></span>
		</td>
		</tr>
		...
		<td valign="top" class="printlabel">
			...
			<cfif snap_phone NEQ ""><span class="printlabel">Phone:</span> #snap_phone#&nbsp;&nbsp;&nbsp;</cfif></span>		
		</td>
		</tr>
