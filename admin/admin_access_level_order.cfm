...
<form method="post" action="#CurrentPage#">
	...
	<cfoutput query="SelectList">
		...
		<input type="hidden" name="lc#loopcounter#_sortorder_required" value="You must enter a sort order for code number #ID# (#safe_level_name#).">
		<input type="hidden" name="lc#loopcounter#_level_name_required" value="You must enter a level name for code number #ID#.">
		</td>
		</tr>
	</cfoutput>
	<tr class="content">
