...
<cfif pgfn EQ "list">
	...
	<cfelse>
		...
		<cfoutput query="SelectList" startrow="#StartRow_SelectList#" maxrows="#MaxRows_SelectList#">
			...
			<td valign="top" width="175">#HTMLEditFormat(level_name)#</td>
...
<cfelseif pgfn EQ "add" OR pgfn EQ "edit" OR pgfn EQ "copy">
	...
	<tr class="content">
	<td align="right" valign="top">Optional Note: </td>
	...
	<input type="hidden" name="level_name_required" value="You must enter a level name.">
