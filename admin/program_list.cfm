...
<cfif copy NEQ ''>
	...
	<cflocation url="program_details.cfm?ID=#new_ID#" addtoken="no">
</cfif>
...
<table cellpadding="5" cellspacing="1" border="0" width="100%">
	...
	<cfoutput query="SelectList">
					...
					<cfif FindLink3.thismany EQ 0>
						...
						<cfif FindLink4.thismany EQ 0>
							<cfquery name="FindLink5" datasource="#application.DS#">
								SELECT COUNT(ID) as thismany
								FROM #application.product_database#.productvalue_program 
								WHERE program_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#ID#" maxlength="10"> 
							</cfquery>
		...
		<td ><cfif setup_details><span class="alert">setup<br></span></cfif><a href="program_details.cfm?id=#ID#">Details</a>&nbsp;&nbsp;&nbsp;<a href="#CurrentPage#?copy=#ID#">Copy</a><cfif FLGen_HasAdminAccess(1000000051) and show_delete>&nbsp;&nbsp;&nbsp;<a href="#CurrentPage#?delete=#ID#" onclick="return confirm('Are you sure you want to delete this program?  There is NO UNDO.')">Delete</a></cfif></td>
		...
		<td valign="top" align="right"><cfif HasLog.RecordCount IS 0><span class="alert">setup<br></span></cfif><a href="program_login.cfm?pgfn=list&program_ID=#ID#">Logins</a></td>
		<td valign="top" align="right"><cfif HasUsers.RecordCount IS 0><span class="alert">setup<br></span> </cfif><a href="program_user.cfm?program_ID=#ID#">Users</a></td>
		<td valign="top" align="right"><cfif HasCat.RecordCount IS 0><span class="alert">setup<br></span></cfif><a href="program_category.cfm?program_ID=#ID#">Categories</a></td>
		<td valign="top" align="right"><cfif HasCat.RecordCount NEQ 0><a href="program_product.cfm?program_ID=#ID#">Products</a></cfif></td>
		</tr>
	</cfoutput>
</table>
