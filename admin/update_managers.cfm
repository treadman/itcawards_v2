...
<cfif NOT isDefined("GetProgram") OR GetProgram.recordcount NEQ 1>
	<cflocation url="pickprogram.cfm?n=update_managers" addtoken="no">
</cfif>

<cfparam name="alert_msg" default="">

<cfset thisFileName = "update_mgrs#Replace(CGI.REMOTE_ADDR,'.','','ALL')#">
...
<cfif IsDefined("form.submitEmail") OR IsDefined("form.submitTest")>
	...
	<cfset hasFile = true>
	<cftry>
		<cffile action="read" variable="thisData" file="#application.AbsPath#admin/upload/#thisFileName#.csv">
...
<span class="pagetitle">
	Update managers in<cfoutput>#GetProgram.company_name# [#GetProgram.program_name#]</cfoutput> &nbsp;&nbsp;&nbsp;&nbsp; <a href="<cfoutput>#CurrentPage#</cfoutput>">Start Over</a>
</span>
<br /><br />
