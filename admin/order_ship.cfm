...
<cfelseif NOT IsDefined("order_ID") OR order_ID IS "">
	<cfif back EQ ""><cfset back = "order"></cfif>
	<cfif back EQ "order" OR back EQ "report_fulfillment">
		<cflocation url="#back#.cfm?&xT=#xT#&xTD=#xTD#&xFD=#xFD#&program_ID=#program_ID#&OnPage=#OnPage#" addtoken="no">
	<cfelseif back EQ "ups_group">
		<cflocation url="#back#.cfm?&item=#item#" addtoken="no">
	<cfelse>
		<cflocation url="order.cfm?&xT=#xT#&xTD=#xTD#&xFD=#xFD#&program_ID=#program_ID#&OnPage=#OnPage#" addtoken="no">
	</cfif>
</cfif>
...
<cfif FindOrderInfo.RecordCount eq 0>
...
<cfoutput>
<cfif back EQ "order">
	<span class="pageinstructions">Return to <a href="#back#.cfm?&xT=#xT#&xTD=#xTD#&xFD=#xFD#&program_ID=#program_ID#&OnPage=#OnPage#">Order List</a> without making changes.</span>
<cfelseif back EQ "report_fulfillment">
	<span class="pageinstructions">Return to <a href="#back#.cfm?&xT=#xT#&xTD=#xTD#&xFD=#xFD#&program_ID=#program_ID#&OnPage=#OnPage#">Ship From ITC</a> without making changes.</span>
<cfelseif back EQ "ups_group">
	<span class="pageinstructions">Return to <a href="#back#.cfm?&item=#item#">Create UPS Group</a> without making changes.</span>
</cfif>
<br /><br />
<!--- <span class="pageinstructions">Open <a href="order_detail_printable?order_ID=#order_ID#">printable order</a>.</span>
<br /><br />
 --->	
<cfif FindOrderInfo.RecordCount gt 0>	
<form method="post" action="#CurrentPage#">
	...
	<td><input type="text" name="tracking" value="" maxlength="32"><input type="hidden" name="tracking_required" value="You must enter a tracking number."></td>
	<td align="right">date of shipment:</td>
	<td><input type="text" name="ship_date" value="#FLGen_DateTimeToDisplay()#"><input type="hidden" name="ship_date_required" value="You must enter a date of shipment."></td>
	</tr>
...
<table cellpadding="3" cellspacing="1" border="0" width="100%">
	...
	<tr>
	<td colspan="2" class="content2"><a href="order.cfm?pgfn=edit&order_ID=#order_ID#&xT=#xT#&xTD=#xTD#&xFD=#xFD#&program_ID=#program_ID#&OnPage=#OnPage#">Edit Order Information</a></td>
	</tr>
