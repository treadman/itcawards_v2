...
<cfif IsDefined('form.Submit')>
	...
	<cfif found_one>
				...
				<cfif FormField CONTAINS "inv_">
					...
					<cfquery name="FindVendorSku" datasource="#application.DS#">
						...
						FROM #application.product_database#.vendor_lookup vl
							JOIN #application.product_database#.product prod ON vl.product_ID = prod.ID 
					...
					<cfquery name="UpdateDropItem" datasource="#application.DS#">
						...
						SET po_ID= <cfqueryparam cfsqltype="cf_sql_integer" value="#new_po_ID#" maxlength="10">,
							...
							vendor_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#GetVendorInfoForSnaps.vendor_ID#" >, 
		...
		<cflocation addtoken="no" url="po_detail.cfm?pgfn=detail&po_ID=#new_po_ID#&xT=#xTD#=&xFD=#xFD#&v_ID=#v_ID#&OnPage=#OnPage#&new=yes">
	<cfelse>
		<cfset alert_msg = 'You must select at least one item to create a new purchase order.'>	
	</cfif>
...
<br /><br />
<span class="pageinstructions">Return to <a href="report_po.cfm">Potential Purchase Orders</a> without making changes.</span>
<br /><br />
		...
		<cfif is_dropshipped EQ 1>
			...
			<cfloop query="AnyUnDropped">
				...
				<cfquery name="OrderInfo" datasource="#application.DS#">
					SELECT created_user_ID, order_number, snap_ship_fname, snap_ship_lname, snap_ship_address1, snap_ship_address2, snap_ship_city, snap_ship_state, snap_ship_zip, program_ID 
				...
				<td>
					...
					#OrderInfo.snap_ship_fname# #OrderInfo.snap_ship_lname#, #OrderInfo.snap_ship_address1# #OrderInfo.snap_ship_address2#, #OrderInfo.snap_ship_city#, #OrderInfo.snap_ship_state# #OrderInfo.snap_ship_zip#
				</td>
				</tr>
			</cfloop>
		</cfif>
