...
<cfoutput>
<span class="pagetitle">Billing Report<cfif program_name NEQ ""> for #program_name#</cfif></span>
<br /><br />
...
<table cellpadding="5" cellspacing="0" border="0" width="100%">
	...
	<td class="content">
		...
		<cfelseif program_ID EQ "">
			Please select a program from the upper left.
		</cfif>
	</td>
...
<cfif IsDefined('form.submit') AND isNumeric(program_ID)>
	...
	<!--- header row --->
	<tr class="content2">
	<td colspan="<cfif report_type EQ 'tran'>5<cfelse>6</cfif>"><span class="headertext">Program: <span class="selecteditem"><cfoutput>#program_name#</span></span></cfoutput></td>
	</tr>
	...
	<cfloop query="FindAllUsers">
		...
		<cfif report_type EQ 'zero' OR report_type EQ 'part' OR report_type EQ 'bala'>
			#ProgramUserInfoConstrained(thisUserID,formatFromDate,formatToDate)# 
			<!--- 	BRp_pospoints
					BRp_negpoints
					BRp_totalpoints
					BRp_deferedpoints
