...
<cfset FLGen_HasAdminAccess(1000000016,true)>
...
<cfelseif IsDefined('form.Submit2')>
	...
	<cfquery name="GetComments" datasource="#application.DS#">
		...
		WHERE s.program_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#program_ID#" maxlength="10">
...
<!--- get program name --->
<cfif NOT IsDefined('program_ID') OR #program_ID# IS "">
	<cflocation addtoken="no" url="pickprogram.cfm?n=report_survey">
</cfif>
...
<cfoutput>
<span class="pagetitle">Survey Report for #FLITC_GetProgramName(program_ID)#</span>
<br /><br />
...
<span class="pageinstructions"><cfif GetSurveyAction.RecordCount EQ 0>
	<span class="alert">This Award Program has no surveys.</span></cfif><br><br> Choose a different <a href="pickprogram.cfm?n=report_survey">Award Program</a>.</span>
<br /><br />
</cfoutput>
...
<cfoutput>
	<tr class="content2">
	<td><span class="headertext">Program: <span class="selecteditem">#FLITC_GetProgramName(program_ID)#</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#GetComments.RecordCount# Comments Total</td>
	</tr>
</cfoutput>
