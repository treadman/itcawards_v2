...
<cfquery name="GetPOInfo" datasource="#application.DS#">
	SELECT vendor_ID, snap_vendor, snap_attention, snap_phone, snap_fax, is_dropship, itc_name, itc_phone, itc_fax, itc_email, po_printed_note, po_hidden_note, CAST(po_rec_date AS CHAR) AS po_rec_date, Date_Format(created_datetime,'%c/%d/%Y') AS this_po_date, modified_concat  
...
<tr>
	<td colspan="4" align="left"><img src="<cfoutput>#application.SecureWebPath#</cfoutput>/pics/itclogo.jpg" width="794" height="149"></td>
</tr>
<tr>
...
<tr>
	<td colspan="4" align="left" class="printtext">
		...
		<cfmail from="#application.AwardsFromEmail#" to="#form.emailto#, #thisFrom#" subject="PO From ITC" type="html">
#emailBody#
		</cfmail>
	...
	<form name="emailPOForm" action="#CurrentPage#?#CGI.QUERY_STRING#" method="post">
		<table cellpadding="5" cellspacing="0" border="0">
			<tr class="content">
				...
				<td class="content2"><input type="text" name="emailto" value="#form.emailto#" size="50" maxlength="512"></td>
			</tr>
			<tr class="content">
			...
			<cfif FindOrders.RecordCount GT 0>
				<tr class="content">
					...
					<td colspan="3" class="selectedbgcolor">
						...
						<span ID="row_#ID#" style="display:none"><cfloop query="FindOrders">#FLITC_GetProgramName(program_ID)# Order #order_number# #FLGen_DateTimeToDisplay(created_datetime)#<br />#snap_fname# #snap_lname#&nbsp;&nbsp;&nbsp;#snap_email#&nbsp;&nbsp;&nbsp;#snap_phone#<br /><br /></cfloop></span>
					</td>
