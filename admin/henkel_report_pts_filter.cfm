...
<cfset FLGen_HasAdminAccess(1000000109,true)>
...
<cfset leftnavon = "henkel_report_pts_filter">
...
<input type="hidden" name="show_pending" value="#show_pending#">
<input type="hidden" name="show_individual" value="#show_individual#">
<input type="hidden" name="show_branch" value="#show_branch#">
<input type="hidden" name="show_branchHQ" value="#show_branchHQ#">
...
<cfif isDefined("form.submit")>
	<cfif (show_active OR show_pending) AND (show_individual OR show_branch OR show_branchHQ)>
		<cfquery name="SelectList" datasource="#application.DS#">
			<cfif show_individual OR show_branch>
				...
				AND HR.created_datetime BETWEEN <cfqueryparam value="#formatFromDate#"> AND <cfqueryparam value="#formatToDate#">
		...
		AND u.is_active = 1
		AND p.created_datetime BETWEEN <cfqueryparam value="#formatFromDate#"> AND <cfqueryparam value="#formatToDate#">
		AND u.ID NOT IN (
	...
	<table cellpadding="5" cellspacing="1" border="0" width="100%">
		...
		<tr>
			...
			<td class="totals" align="right">#SelectList.RecordCount#</td>
