...
<cfif IsDefined('form.Submit')>
	...
	<cfset alert_msg = "Your inventory adjustment was saved.#FLGen_SubStamp()#">
	<cfset pgfn = "edit">
 ...
 of #TotalPages_SelectList# ]&nbsp;&nbsp;&nbsp;[ records #StartRow_SelectList# - #EndRow_SelectList# of #SelectList.RecordCount# ]
	...
	<cfif totalprods NEQ 0>
		...
		<cfoutput query="SelectList" startrow="#StartRow_SelectList#" maxrows="#MaxRows_SelectList#">
			...
			<td valign="top" align="right">#PhysicalInvCalc(product_ID)#<b>#PIC_total_physical#</b></td>
...
<cfelseif pgfn EQ "edit">
	...
	<cfquery name="FindProductInfo" datasource="#application.DS#">
		SELECT m.meta_name
		FROM #application.product_database#.product_meta m
		JOIN #application.product_database#.product p ON p.product_meta_ID = m.ID
	...
	<tr class="content">
	<td colspan="2" class="headertext">Product: <span class="selecteditem">#FindProductInfo.meta_name# #FindProductOptions(product_ID)##FPO_theseoptions#</span></td>
	</tr>
	<cfif FindProductOptionInfo.RecordCount NEQ 0><br>
		<tr class="content">
		<td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<form method="post" action="#CurrentPage#">
		...
		<input type="hidden" name="quantity_required" value="You must enter a quantity to add or subtract."></td>
		</tr>
		...
		<input type="hidden" name="note_required" value="You must enter a note that explains why you are adjusting the inventory."></td>
		</tr>
		...
		<input type="reset" value="Reset" >&nbsp;&nbsp;&nbsp;<input type="submit" name="submit" value="Save Inventory Adjustment" >
	...
	<tr class="content2">
	<td align="right" class="headertext" colspan="2">#PhysicalInvCalc(product_ID)##PIC_total_virtual#</td>
	<cfif FLGen_HasAdminAccess(1000000049)>
