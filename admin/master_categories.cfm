...
<cfif IsDefined('form.Submit')>
	...
	<cfif form.ID IS NOT "">
		<cfquery name="UpdateQuery" datasource="#application.DS#">
			UPDATE #application.product_database#.productvalue_master
		...
		<cflock name="productvalue_masterLock" timeout="10">
			<cftransaction>
				<cfquery name="InsertQuery" datasource="#application.DS#">
					INSERT INTO #application.product_database#.productvalue_master
				...
				<cfquery name="getID" datasource="#application.DS#">
					SELECT Max(ID) As MaxID FROM #application.product_database#.productvalue_master
				</cfquery>
...
<cfelseif pgfn EQ "add" OR pgfn EQ "edit">
	...
	<input type="hidden" name="productvalue_required" value="You must enter a display name.">
	<input type="hidden" name="sortorder_required" value="You must enter a sort order.">
