...
<cfif IsDefined('form.Submit')>
	...
	<cfif form.pmoc_ID IS NOT "">
		...
		<cfquery name="UpdatePMOCQuery" datasource="#application.DS#">
			UPDATE #application.product_database#.product_meta_option_category
		...
		<cfloop list="#ExistingOptions#" index="ind">
			...
			<cfquery name="UpdatePMOQuery" datasource="#application.DS#">
				UPDATE #application.product_database#.product_meta_option
		...
		<cfloop from="1" to="#form.blank_categories#" index="ix">
			...
			<cfif thisnewOptName NEQ "" AND thisnewOptSort NEQ "">
				<cfquery name="InsertNewPMO" datasource="#application.DS#">
					INSERT INTO #application.product_database#.product_meta_option
		...
		<cflock name="product_meta_option_categoryLock" timeout="10">
			<cftransaction>
				<cfquery name="InsertQuery" datasource="#application.DS#">
					INSERT INTO #application.product_database#.product_meta_option_category
						(created_user_ID, created_datetime, product_meta_ID, category_name, sortorder)
					VALUES (
				...
				<cfquery datasource="#application.DS#" name="getID">
						SELECT Max(ID) As MaxID FROM #application.product_database#.product_meta_option_category
				</cfquery>
...
<form method="post" action="#CurrentPage#">
	...
	<cfif pgfn EQ "add">
		...
		<input type="hidden" name="category_name_required" value="You must enter a category name.">
		<input type="hidden" name="sortorder_required" value="You must enter a category sort order.">
		<input type="hidden" name="options_required" value="You must enter options.">
	...
	<cfelseif pgfn EQ "edit">
		...
		<cfloop query="EditOptions">
			...
			<input type="hidden" name="pmo_sortorderx#pmo_ID#_required" value="You must enter a sort order for the existing categories.">
			<input type="hidden" name="optionx#pmo_ID#_required" value="You must enter a category name for all existing categories.">
		</cfloop>
		</td>
		</tr>
		...
		<tr class="content2">
		<td valign="top">&nbsp;</td>
		<td valign="top"><img src="../pics/contrls-desc.gif"> Click "Add Another Blank Option" to create all of the<br>&nbsp;&nbsp;&nbsp;blank fields you need <b>before</b> making any edits.</td>
		</tr>
		...
		<td>
			...
			<cfset bnum = b + 1>
		<a href="#CurrentPage#?pgfn=edit&pmoc_ID=#pmoc_ID#&meta_ID=#meta_ID#&xS=#xS#&xL=#xL#&xT=#xT#&OnPage=#OnPage#&b=#bnum#&xW=#xW#">Add Another Blank Option</a>
			<input type="hidden" name="blank_categories" value="#b#">
			<input type="hidden" name="category_name_required" value="You must enter a category name.">
			<input type="hidden" name="pmoc_sortorder_required" value="You must enter a category sort order.">
