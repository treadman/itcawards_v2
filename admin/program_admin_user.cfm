...
<cfif IsDefined('form.Submit') AND form.Submit IS NOT "" AND IsDefined('form.username') AND form.username IS NOT "">
	...
	<cfquery name="AnyDuplicateUsernames" datasource="#application.DS#">
		...
		AND program_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#ListGetAt(cookie.itc_program,1,'-')#">
	...
	<cfif AnyDuplicateUsernames.RecordCount EQ 0>
		...
		<cfelse>
					...
					<cfquery name="InsertQuery" datasource="#application.DS#">
						...
						VALUES
							...
							<cfqueryparam cfsqltype="cf_sql_char" value="#form.ship_state#" maxlength="2" null="#YesNoFormat(NOT Len(Trim(form.ship_state)))#">,
							 ...
							 <cfqueryparam cfsqltype="cf_sql_integer" value="#ListGetAt(cookie.itc_program,1,'-')#">,
							 1)
					</cfquery>
			...
			<cfif form.submit EQ "Save and go to Add Points page">
				<cfset go_here = "#CurrentPage#?pgfn=points&puser_ID=#puser_ID#&xxS=#xxS#&xxL=#xxL#&xxT=#xxT#&xOnPage=#xOnPage#">
				<cflocation addtoken="no" url="#go_here#">
			</cfif>
		</cfif>
		<cfset datasaved = "yes">
		<cfset pgfn = "edit">
...
<cfelseif IsDefined('form.Submit') AND form.Submit IS NOT "" AND IsDefined('form.point_amount') AND Trim(form.point_amount) IS NOT "">
...
<cfif pgfn EQ "list">
	...
	<cfquery name="SelectProgramInfo" datasource="#application.DS#">
		SELECT company_name, IF(is_one_item=1,"true","false") AS is_one_item 
		FROM #application.database#.program
		WHERE ID=<cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#ListGetAt(cookie.itc_program,1,'-')#">
	</cfquery>
	<cfset THIS_is_one_item = SelectProgramInfo.is_one_item>
	...
	<td class="content" colspan="2" align="center">
		...
		<br>
		<cfoutput><cfif LEN(xxL) IS 0><span class="ltrON">ALL</span><cfelse><a href="#CurrentPage#?xxL=&xxS=#xxS#" class="ltr">ALL</a></cfif></cfoutput><span class="ltrPIPE">&nbsp;&nbsp;</span><cfloop index = "LoopCount" from = "0" to = "9"><cfoutput><cfif xxL IS LoopCount><span class="ltrON">#LoopCount#</span><cfelse><a href="#CurrentPage#?xxL=#LoopCount#&xxS=#xxS#" class="ltr">#LoopCount#</a></cfif></cfoutput><span class="ltrPIPE">&nbsp;&nbsp;</span></cfloop><cfloop index = "LoopCount" from = "1" to = "26"><cfoutput><cfif xxL IS CHR(LoopCount + 64)><span class="ltrON">#CHR(LoopCount + 64)#</span><cfelse><a href="#CurrentPage#?xxL=#CHR(LoopCount + 64)#&xxS=#xxS#" class="ltr">#CHR(LoopCount + 64)#</a></cfif></cfoutput><cfif LoopCount NEQ 26><span class="ltrPIPE">&nbsp;&nbsp;</span></cfif></cfloop>
	</td>
	</tr>
	</table>
	<br />
	...
	<td>
		<cfif xOnPage GT 1>
			<a href="<cfoutput>#CurrentPage#?xOnPage=1&xxS=#xxS#&xxL=#xxL#&xxT=#xxT#</cfoutput>" class="pagingcontrols">&laquo;</a>&nbsp;&nbsp;&nbsp;<a href="<cfoutput>#CurrentPage#?xOnPage=#Max(DecrementValue(xOnPage),1)#&xxS=#xxS#&xxL=#xxL#&xxT=#xxT#&xL=#xL#&xT=#xT#&OnPage=#OnPage#</cfoutput>" class="pagingcontrols">&lsaquo;</a>
		<cfelse>
	...
	<td align="right">
		<cfif xOnPage LT TotalPages_SelectList>
			<a href="<cfoutput>#CurrentPage#?xOnPage=#Min(IncrementValue(xOnPage),TotalPages_SelectList)#&xxS=#xxS#&xxL=#xxL#&xxT=#xxT#</cfoutput>" class="pagingcontrols">&rsaquo;</a>&nbsp;&nbsp;&nbsp;<a href="<cfoutput>#CurrentPage#?xOnPage=#TotalPages_SelectList#&xxS=#xxS#&xxL=#xxL#&xxT=#xxT#</cfoutput>" class="pagingcontrols">&raquo;</a>
		<cfelse>
	...
	<cfoutput>
	<tr class="content2">
	<td  colspan="<cfif NOT THIS_is_one_item>9<cfelse>5</cfif>"><span class="headertext">Program: <span class="selecteditem">#HTMLEditFormat(SelectProgramInfo.company_name)#</span></span></td>
	</tr>
	<tr class="contenthead">
	...
	<tr class="contenthead">
	<cfif NOT THIS_is_one_item>
	<td colspan="2" align="center">&nbsp;<!--- <a href="#CurrentPage#?pgfn=points&xxS=#xxS#&xxL=#xxL#&xxT=#xxT#">+/-&nbsp;for&nbsp;all&nbsp;users</a> ---></td>
	<cfelse>
	...
	<cfif SelectList.RecordCount IS 0>
		<tr class="content2">
			<td colspan="<cfif NOT THIS_is_one_item>6<cfelse>5</cfif>" align="center"><span class="alert"><br>No records found.  Click "view all" to see all records.<br><br></span></td>
		</tr>
	<cfelse>
		...
		<cfoutput query="SelectList" startrow="#StartRow_SelectList#" maxrows="#MaxRows_SelectList#">
			...
			<cfif NOT THIS_is_one_item>
				...
				<td valign="top" align="right">#ProgramUserInfo(SelectList.puser_ID)#</td>
...
<cfelseif pgfn EQ "add" OR pgfn EQ "edit">
	...
	<table cellpadding="5" cellspacing="1" border="0" width="100%">
	<tr class="content2">
	<td  colspan="2"><span class="headertext">Program: <span class="selecteditem">#FLITC_GetProgramName(ListGetAt(cookie.itc_program,1,'-'))#</span></span></td>
	</tr>
	<tr class="contenthead">
	...
	<cfif THIS_is_one_item>
		<tr class="content">
		<td align="right" valign="top">Has ordered one item?: </td>
		<td valign="top">
			<select name="is_done">
...
<cfelseif pgfn EQ "points">
	...
	<table cellpadding="5" cellspacing="1" border="0" width="100%">
	<tr class="content2">
	<td  colspan="3"><span class="headertext">Program: <span class="selecteditem">#FLITC_GetProgramName(ListGetAt(cookie.itc_program,1,'-'))#</span></span></td>
	</tr>
	...
	<input type="hidden" name="point_amount_required" value="You must enter a number of points to add or subtract."></td>
