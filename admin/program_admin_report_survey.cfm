...
<cfset FLGen_HasAdminAccess(1000000083,true)>
...
<cfif (IsDefined('form.Submit1') AND form.Submit1 IS NOT "") OR (IsDefined('form.Submit2') AND form.Submit2 IS NOT "")>
	<cfset action_clause = " ">
...
<!--- Survey Report --->
<cfif IsDefined('form.Submit1') AND #form.Submit1# IS NOT "">
	<cfset report = "survey">
...
<!--- Comment Report --->
<cfelseif IsDefined('form.Submit2') AND #form.Submit2# IS NOT "">
	...
	<cfquery name="GetComments" datasource="#application.DS#">
		...
		WHERE s.program_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#ListGetAt(cookie.itc_program,1,'-')#">
...
<cfset leftnavon = "programadminsurveyreport">
...
<cfoutput>
<span class="pagetitle">Survey Report for #FLITC_GetProgramName(ListGetAt(cookie.itc_program,1,'-'))#</span>
<br /><br />
...
<span class="pageinstructions">
	<span class="alert">This Award Program has no surveys.</span></span>
<br /><br />
</cfif>
</cfoutput>
...
<cfif GetSurveyAction.RecordCount NEQ 0>
	...
	<td class="content" align="center">
		...
		<cfelse>
				...
				<cfoutput query="GetSurveyAction">
...
<cfoutput>
	<tr class="content2">
	<td><span class="headertext">Program: <span class="selecteditem">#FLITC_GetProgramName(ListGetAt(cookie.itc_program,1,'-'))#</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#GetComments.RecordCount# Comments Total</td>
	</tr>
</cfoutput>
