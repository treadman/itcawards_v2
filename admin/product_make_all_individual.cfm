...
<cfif IsDefined('meta_ID') AND meta_ID IS NOT "" AND IsDefined('pgfn') AND pgfn IS NOT "">
	...
	<cfif this_many_option_categories GT 3>
		<cflocation addtoken="no" url="product.cfm?pgfn=edit&meta_ID=#meta_ID#&xS=#xS#&xL=#xL#&xT=#xT#&xW=#xW#&xA=#xA#&OnPage=#OnPage#&alert_msg=The%20individual%20products%20could%20not%20be%20made.[message3]">
	</cfif>
	...
	<!--- there are too many individual products to make --->
	<cfif this_many_individual GT 130>
		<cflocation addtoken="no" url="product.cfm?pgfn=edit&meta_ID=#meta_ID#&xS=#xS#&xL=#xL#&xT=#xT#&xW=#xW#&xA=#xA#&OnPage=#OnPage#&alert_error=The%20individual%20products%20could%20not%20be%20made.[message1][#this_many_individual#]">
	</cfif>
	...
	<cfloop index="LoopCount" from="1" to="130">
		...
		<cfelseif LoopCount LTE 130>
			<cfset use_this_letter = CHR((LoopCount - 104) + 96) & CHR((LoopCount - 104) + 96) & CHR((LoopCount - 104) + 96) & CHR((LoopCount - 104) + 96) & CHR((LoopCount - 104) + 96)>
		</cfif>
	...
	<cfif this_many_option_categories EQ 1>
		...
		<cflocation addtoken="no" url="product.cfm?pgfn=edit&meta_ID=#meta_ID#&xS=#xS#&xL=#xL#&xT=#xT#&xW=#xW#&xA=#xA#&OnPage=#OnPage#&alert_msg=The%20individual%20products%20were%20created.">
...
<cfelse>
	...
	<cflocation addtoken="no" url="product.cfm?pgfn=edit&meta_ID=#meta_ID#&xS=#xS#&xL=#xL#&xT=#xT#&xW=#xW#&xA=#xA#&OnPage=#OnPage#&alert_msg=The%20individual%20products%20could%20not%20be%20made.[message2]">
