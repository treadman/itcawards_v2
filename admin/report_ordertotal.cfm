...
<cfoutput>
<span class="pagetitle">Order Totals Report<cfif program_ID NEQ ""> for #FLITC_GetProgramName(program_ID)#</cfif></span>
<br /><br />
</cfoutput>
...
<cfelseif IsDefined('form.submit')>
	...
	<cfif FromDate NEQ "">
		...
		<cfquery name="CON_UserDefer" datasource="#application.DS#">
			...
			WHERE up.program_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#program_ID#" maxlength="10">
				AND ap.is_defered = 1
	...
	<cfloop query="UserOrderTotal">
		<cfoutput>#ProgramUserInfo(order_users_ID)#</cfoutput>
	...
	<table cellpadding="5" cellspacing="1" border="0" width="100%">
		...
		<!--- header row --->
		<tr class="content2">
		<td colspan="<cfif FromDate NEQ ''>3<cfelse>2</cfif>"><span class="headertext">Program: <span class="selecteditem"><cfoutput>#FLITC_GetProgramName(program_ID)#</span></span></cfoutput></td>
		</tr>
		...
		<td>Potential Order Makers&nbsp;&nbsp;&nbsp;<a href="report_potentialorderers.cfm?program_ID=#program_ID#" target="_blank">view list</a></td>
		</tr>
