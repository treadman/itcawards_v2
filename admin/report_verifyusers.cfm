...
<table cellpadding="5" cellspacing="1" border="0" width="100%">
	...
	<cfif getUsers.RecordCount EQ 0>
		<tr class="content2">
		<td colspan="6" align="center" class="alert"><br>There are no users to display.<br><br></td>
		</tr>
	</cfif>

	<cfoutput query="getUsers" group="program_ID">
		<tr class="content2">
			<td colspan="6" class="headertext">#FLITC_GetProgramName(program_ID)#</td>
		</tr>
		<cfoutput>
			<!--- calculate points --->
			#ProgramUserInfo(ID)#
			...
			<td valign="top" align="right"><a href="program_user.cfm?pgfn=edit&program_ID=#program_ID#&puser_id=#ID#">edit</a><br><span style="font-size:18px">&nbsp;</span><a href="#CurrentPage#?remove=#ID#">remove from list</a></td>
			...
			<td valign="top" colspan="4">Entered by #FLGen_GetAdminName(created_user_ID)# #created_datetime#<cfif modified_concat NEQ ""><br><br>Modified:<br><br>#FLGen_DisplayModConcat(modified_concat)#</cfif></td>
			<td bgcolor="##FFFFFF">&nbsp;</td>
			</tr>
		</cfoutput>
	</cfoutput>
