...
<cfif pgfn EQ "save">
	<cfif prod_ID GT 0>
		<cfset FL_ExcludeProgram(prod_ID, program_ID)>
	<cfelse>	
		...
		<cfloop query="ProductIDList">
			<cfset FL_ExcludeProgram(ProductIDList.ID, program_ID)>
		</cfloop>
	</cfif>
...
//  End -->
	...
	<form method="post" action="<cfoutput>#CurrentPage#</cfoutput>" name="myform">
		<input type="button" name="CheckAll" value="Check All" onClick="checkAll(document.myform.program_id)">
		<input type="button" name="UnCheckAll" value="Uncheck All" onClick="uncheckAll(document.myform.program_id)">
		<table border="0">
			<tr><th>&nbsp;</th><th>Program</th></tr>
			<cfoutput query="ListOfActivePrograms">
				<tr>
					<td><input name="program_id" type="checkbox" value="#ID#"></td>
			...
			<tr>
				...
				<input type="button" name="CheckAll" value="Check All" onClick="checkAll(document.myform.program_id)">
				<input type="button" name="UnCheckAll" value="Uncheck All" onClick="uncheckAll(document.myform.program_id)"><br />
					<cfoutput>
