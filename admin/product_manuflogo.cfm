...
<cfif IsDefined('form.Submit')>
	...
	<cfif form.ID IS NOT "">
		<cfquery name="UpdateQuery" datasource="#application.DS#">
			UPDATE #application.product_database#.manuf_logo
		...
		<cflock name="manuf_logoLock" timeout="10">
			<cftransaction>
				<cfquery name="InsertQuery" datasource="#application.DS#">
					INSERT INTO #application.product_database#.manuf_logo
				...
				<cfquery name="getID" datasource="#application.DS#">
					SELECT Max(ID) As MaxID FROM #application.product_database#.manuf_logo
				</cfquery>
...
<cfelseif pgfn EQ "add" OR pgfn EQ "edit">
	...
	<td valign="top"><input type="text" name="manuf_name" value="#manuf_name#" maxlength="20" size="40"></td>
	</tr>
	
	<tr class="content">
	<td align="right" valign="top">Manufacturer's Logo: </td>
	<td valign="top"><input name="logoname_original" type="FILE" value=""><cfif logoname NEQ "">&nbsp;&nbsp;&nbsp;&nbsp;current image: <a href="../pics/manuf_logos/#HTMLEditFormat(logoname)#" target="_blank">#htmleditformat(logoname_original)#</a></cfif></td>
	</tr>
	...
	<input type="hidden" name="manuf_name_required" value="You must enter a Manufacturer's Name.">
