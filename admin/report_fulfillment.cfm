...
<cfif List_ProductsWithInventory EQ "">
	...
	<cfset alert_msg = "There are no products with sufficient inventory waiting to be shipped from ITC.  Click PO Builder to see if any physical stock needs to be ordered.">
	
<!--- loop through products, build up order/program/quantity query object --->
<cfelse>

	<cfset OrdersToDisplay = QueryNew("product_ID, program_ID, order_ID, quantity, order_number, snap_fname, snap_lname, snap_ship_company, snap_ship_fname, snap_ship_lname, snap_ship_address1, snap_ship_address2, snap_ship_city, snap_ship_state, snap_ship_zip, snap_phone, snap_email, order_note,snap_order_total, points_used, cc_charge","Integer, Integer, Integer, Integer, Integer, VarChar, VarChar, VarChar, VarChar, VarChar, VarChar, VarChar, VarChar, VarChar, VarChar, VarChar, VarChar, VarChar,Decimal, Integer, Decimal")>
	...
	<cfloop list="#List_ProductsWithInventory#" index="loop_i">
		...
		<cfquery name="SelectOrderID" datasource="#application.DS#" maxrows="#loop_physicaltotal#">
			SELECT inv.order_ID, ord.program_ID, inv.quantity, ord.order_number, ord.snap_fname, ord.snap_lname, ord.snap_ship_company, ord.snap_ship_fname, ord.snap_ship_lname, ord.snap_ship_address1, ord.snap_ship_address2, ord.snap_ship_city, ord.snap_ship_state, ord.snap_ship_zip, ord.snap_phone, ord.snap_email, ord.order_note, ord.snap_order_total, points_used, cc_charge
		...
		<cfif SelectOrderID.RecordCount GT 0>
			...
			<cfloop query="SelectOrderID">
				...
				<cfif QuantityCounter LTE loop_physicaltotal>
					...
					<cfset QuerySetCell(OrdersToDisplay,"cc_charge",SelectOrderID.cc_charge,loop_counter)>
...
<br><br>
	...
	<cfloop list="#List_ProductsWithInventory#" index="listloop_prodinv">
		...
		<cfif search_text EQ "" OR SelectProductsOrders.recordcount gt 0>
			...
			<cfoutput>
				<tr class="contenthead">
				<td align="center"> <a href="##" onclick="submit_hidden_form('#individual_ID#',quantity_list#javascript_counter#,order_list#javascript_counter#);return false;" style="visibility:hidden" id="order_list_link#javascript_counter#">print</a><cfif FLGen_HasAdminAccess(1000000082)><br><a href="ups_group_create.cfm?item=#individual_ID#">ups&nbsp;group</a></cfif></td>
			...
			<cfloop query="SelectProductsOrders">
				...
				<tr class="content">
				<td colspan="4"><cfoutput><span class="sub">QTY: #thisindv_qty# to be shipped in the multi-item #FLITC_GetProgramName(FindOrderInfo.this_program_ID)# Order #FindOrderInfo.order_number# (see below)</span></cfoutput></td>
				</tr>
			...
			<td colspan="4">
				...
				<td valign="top" width="40%">
					QTY: #thisindv_qty#<br>
					#FLITC_GetProgramName(FindOrderInfo.program_ID)# Order #FindOrderInfo.order_number#<br>
	...
	<cfloop list="#List_MultiProductOrders#" index="mpo_i">
		...
		<cfquery name="FindMultiOrderInfo" dbtype="query">
			SELECT program_ID, order_ID, order_number, snap_fname, snap_lname, snap_ship_company, snap_ship_fname, snap_ship_lname, snap_ship_address1, snap_ship_address2, snap_ship_city, snap_ship_state, snap_ship_zip, snap_phone, snap_email, order_note, snap_order_total, points_used, cc_charge 
			FROM OrdersToDisplay
		...
		<cfset cc_charge = HTMLEditFormat(FindMultiOrderInfo.cc_charge)>
		...
		<tr class="contenthead">
		<td class="headertext" colspan="2"><a href="report_fulfillment_printorder.cfm?order=#order_ID#&" target="_blank"><span style="font-weight:normal">print</span></a>&nbsp;&nbsp;&nbsp;#FLITC_GetProgramName(this_program_ID)# Order #order_number#</td>
		</tr>
